    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          //client.println("<iframe src='https://www.w3schools.com'></iframe> ");
          client.println("<script type='text/js'> var html =  $('#pedidos').load('http://187.255.163.75:8080/iComidaREST/rest/icomida/pedidos').html(); console.log(html);</script>");
          client.println("</body>");
          client.println("</html>");
          break;
        }
